...
export function GroupCard({
  ...
  return (
    <Link
      href={`/groups/${id}`}
      className="group block rounded-2xl border border-primary-light/30 bg-surface p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary-light/60 hover:shadow-[0_18px_40px_-24px_rgba(33,28,61,0.55)]"
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="font-display text-xl font-semibold text-text transition-colors group-hover:text-primary">
            {name}
          </h3>
