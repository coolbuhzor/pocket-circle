    ...
    <ol className="space-y-3">
      {events.map((event) => {
        ...
        return (
          <li
            key={event.id}
            className="flex gap-3 rounded-xl border border-primary-light/30 bg-surface p-3 shadow-sm"
          >
            <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary-light/30 text-primary">
