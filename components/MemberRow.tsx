    ...
    <div
      className={cn(
        ...
        isCollector
          ...
          : "border-primary-light/30 bg-surface",
      )}
    >
      ...
      {isAdminView && (
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="rounded-lg p-1.5 text-text-muted hover:bg-primary-light/30 hover:text-primary"
            aria-label="Member actions"
          >
            <MoreHorizontal className="h-4 w-4" />
          </button>
          {menuOpen && (
            <div className="absolute right-0 z-20 mt-1 w-44 rounded-xl border border-primary-light/40 bg-surface py-1 shadow-md">
              {canMoveUp && (
                <button
                  type="button"
